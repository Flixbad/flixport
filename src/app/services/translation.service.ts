  ...
  private loadTranslations() {
    this.translations = {
      fr: {
        ...
        'projects.details.technologies': 'Technologies utilisées',
        'projects.details.challenges': 'Défis rencontrés',
        ...
        'projects.1.challenges': 'Gestion de la synchronisation en temps réel du panier, optimisation des performances avec de grandes quantités de produits, intégration sécurisée des paiements.',
        'projects.1.duration': '3 mois',
        ...
        'projects.2.challenges': 'Gestion de grandes quantités de données en temps réel, création de visualisations performantes, optimisation du rendu des graphiques.',
        'projects.2.duration': '2 mois',
        ...
        'projects.3.challenges': 'Optimisation des performances pour un gameplay fluide à 60 FPS, gestion de la physique du jeu, création d\'un système de scores équilibré.',
        'projects.3.duration': '1.5 mois',
        ...
        'projects.4.challenges': 'Sécurisation de l\'API contre les attaques courantes, optimisation des requêtes MongoDB, création d\'une documentation API complète et interactive.',
        'projects.4.duration': '2.5 mois',
        ...
        'projects.5.challenges': 'Création d\'animations fluides et performantes, optimisation du SEO pour un site Angular, gestion du multi-langue et du thème sombre/clair.',
        'projects.5.duration': '1 mois',
        ...
        'projects.6.challenges': 'Intégration de WebGL pour des graphiques 3D performants, création de mécaniques de jeu complexes, optimisation pour différents appareils.',
        'projects.6.duration': '4 mois',
      ...
      en: {
        ...
        'projects.details.description': 'Description',
        'projects.details.technologies': 'Technologies Used',
        'projects.details.challenges': 'Challenges Encountered',
        ...
        'projects.1.challenges': 'Real-time cart synchronization management, performance optimization with large product quantities, secure payment integration.',
        'projects.1.duration': '3 months',
        ...
        'projects.2.challenges': 'Managing large amounts of real-time data, creating performant visualizations, optimizing chart rendering.',
        'projects.2.duration': '2 months',
        ...
        'projects.3.challenges': 'Performance optimization for smooth 60 FPS gameplay, game physics management, creating a balanced scoring system.',
        'projects.3.duration': '1.5 months',
        ...
        'projects.4.challenges': 'Securing the API against common attacks, optimizing MongoDB queries, creating comprehensive and interactive API documentation.',
        'projects.4.duration': '2.5 months',
        ...
        'projects.5.challenges': 'Creating smooth and performant animations, SEO optimization for an Angular site, managing multi-language and dark/light theme.',
        'projects.5.duration': '1 month',
        ...
        'projects.6.challenges': 'WebGL integration for performant 3D graphics, creating complex game mechanics, optimization for different devices.',
        'projects.6.duration': '4 months',
